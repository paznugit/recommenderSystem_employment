...
for indivId in range(nbIndiv):
    ...
    listuserProfile_content[indivId] = profile_content/float(nboffre)
    listuserProfile_rome[indivId] = profile_rome/float(nboffre)
    listuserProfile_geo[indivId] = profile_geo/float(nboffre)
